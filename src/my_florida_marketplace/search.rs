...
async fn choose_ad_type(driver: WebDriver, one_second: Duration) -> Result<WebDriver, WebDriverError> {
  thread::sleep(one_second);
...
async fn choose_ad_status(driver: WebDriver, one_second: Duration) -> Result<WebDriver, WebDriverError> {
